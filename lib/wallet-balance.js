...
async function getWalletBalance(address, privateKey = null, apiCreds = null) {
  ...
  // freeUsdc = CLOB collateral only. On-chain wallet balance is returned separately
  // via wallet.js → usdcOnChain. Do NOT merge them here to avoid double-counting.
  const freeUsdc = clob !== null ? clob : 0;
